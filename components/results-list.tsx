          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="rounded bg-muted px-2 py-1">
              ...
              {qntdDiff !== 0 && (
                <span
                  className={
                    qntdDiff > 0 ? 'text-green-600 ml-1' : 'text-destructive ml-1'
                  }
                >
                  ({qntdDiff > 0 ? '+' : ''}{qntdDiff})
                </span>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-destructive">{diffEntries.length}</p>
      ...
      {diffEntries.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {diffEntries.length} {diffEntries.length === 1 ? 'item apresenta' : 'itens apresentam'} diferença entre os arquivos
            </CardDescription>
          </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    {eqEntries.length} {eqEntries.length === 1 ? 'item está' : 'itens estão'} em conformidade
                  </CardDescription>
                </div>
